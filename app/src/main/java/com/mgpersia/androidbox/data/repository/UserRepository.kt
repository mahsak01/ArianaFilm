...
interface UserRepository {
    ...
    fun updateNotifications( id: String, updateNotificationFilmInformation: UpdateNotificationFilmInformation): Single<Notification>
    ...
    fun updateUserInformation(information: UpdateUserInformation): Single<User>
