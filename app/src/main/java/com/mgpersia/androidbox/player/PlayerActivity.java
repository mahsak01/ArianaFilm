package com.mgpersia.androidbox.player;
...
import com.mgpersia.androidbox.player.dtpv.youtube.YouTubeOverlay;
...
// https://github.com/google/ExoPlayer/issues/8571
        ...
        if (haveMedia) {
            ...
            titleView.setText(Utils.getFileName(this, mPrefs.mediaUri).replace("arianafilm", "mGpersia"));
    ...
    public void setSelectedTrackSubtitle(final int trackIndex) {
        ...
        if (mappedTrackInfo != null) {
            ...
            final DefaultTrackSelector.Parameters.Builder parametersBuilder = parameters.buildUpon();
